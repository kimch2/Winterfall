...
public class PlayerWeaponEditor : Editor 
{
	public override void OnInspectorGUI () 
	{
		...
		self.predatorTagName = EditorGUILayout.TagField("Predator Tag", self.predatorTagName);
		self.preyTagName = EditorGUILayout.TagField("Prey Tag", self.preyTagName);
		self.enemyTagName = EditorGUILayout.TagField("Enemy Tag", self.enemyTagName);
