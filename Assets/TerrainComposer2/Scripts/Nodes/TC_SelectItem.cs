    ...
    public class TC_SelectItem : TC_ItemBehaviour
    {
        ...
        public void SetPreviewGrassTexture()
        {
            ...
            if (localSettings.hasMasterTerrain)
            {
                ...
                {
                    preview.tex = localSettings.masterTerrain.terrainData.detailPrototypes[selectIndex].prototypeTexture;
                    name = Mathw.CutString(localSettings.masterTerrain.terrainData.detailPrototypes[selectIndex].prototypeTexture.name, TC.nodeLabelLength);
                }
                else active = false;
            }
            else preview.tex = null;
