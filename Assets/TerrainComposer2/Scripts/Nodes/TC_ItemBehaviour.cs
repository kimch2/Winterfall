...
namespace TerrainComposer2
{
    ...
    public class TC_ItemBehaviour : MonoBehaviour
    {
        ...
        public T GetGroup<T>(int index, bool refresh) where T : TC_GroupBehaviour
        {
        ...
        {
            // Debug.Log("Duplicate");
            GameObject newGo = (GameObject)Instantiate(gameObject, transform.position, transform.rotation);
        ...
        public virtual void GetItems(bool refresh) { }
